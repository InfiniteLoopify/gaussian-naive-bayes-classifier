...
class Naive_Bayes:
    def __init__(self):
        ...
        self.training_dataset = pd.read_excel("files/parktraining.xlsx", header=None)
        self.testing_dataset = pd.read_excel("files/parktesting.xlsx", header=None)
        self.accuracy = 0
    ...
    def bayes_calculate(self):
        ...
        for i in range(row_count):
            ...
            for j in range(col_count - 1):
                ...
                sq0 = np.square(self.testing_dataset.at[i, j] - self.zero_mean[j])
                ...
                sq1 = np.square(self.testing_dataset.at[i, j] - self.one_mean[j])

...
<!-- TODO: REPLACE ALL `gaussian-naive-bayes-classifier`, `Naive Bayes Classifier`, `Gaussian Naive Bayes Classifier for Parkinson's disease`. FILL "about the project" and uncomment hidden sections if needed -->
<a name="readme-top"></a>
...
<br />
<div align="center">
  <!-- <a href="https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier">
    <img src="images/logo.png" alt="Logo" width="80" height="80">
  </a> -->
<h3 align="center">Naive Bayes Classifier</h3>

  <p align="center">
    Gaussian Naive Bayes Classifier for Parkinson's disease
    <br />
    <a href="https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <!-- <a href="https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier">View Demo</a>
    · -->
    <a href="https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
<!-- ABOUT THE PROJECT -->
## About The Project
Use Gaussian Naive Bayes Classifier to determine if a person has Parkinson's disease or not, and display the result in a table.

![Screenshot](images/screenshot.png)

*result with accuracy of 89.74%*
...
2. Clone the repository:
    ```bash
    git clone https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier.git
    ```
3. Navigate to the project directory:
    ```bash
    cd gaussian-naive-bayes-classifier
    ```
...
See the [open issues](https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier](https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier)
...
[contributors-shield]: https://img.shields.io/github/contributors/InfiniteLoopify/gaussian-naive-bayes-classifier.svg?style=for-the-badge
[contributors-url]: https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/InfiniteLoopify/gaussian-naive-bayes-classifier.svg?style=for-the-badge
[forks-url]: https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/network/members
[stars-shield]: https://img.shields.io/github/stars/InfiniteLoopify/gaussian-naive-bayes-classifier.svg?style=for-the-badge
[stars-url]: https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/stargazers
[issues-shield]: https://img.shields.io/github/issues/InfiniteLoopify/gaussian-naive-bayes-classifier.svg?style=for-the-badge
[issues-url]: https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/issues
[license-shield]: https://img.shields.io/github/license/InfiniteLoopify/gaussian-naive-bayes-classifier.svg?style=for-the-badge
[license-url]: https://github.com/InfiniteLoopify/gaussian-naive-bayes-classifier/blob/master/LICENSE
